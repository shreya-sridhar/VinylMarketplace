        ...
        return (
            <div class="whole">
                <div class="container bootdey">
                    ...
                    <div class="col-md-12">
                        <RecordToggle record={this.props.record} records={this.props.records}
                                      handleClick={this.props.handleClick} cover={this.props.cover}
                                      addToCart={this.props.addToCart}/>
                        <br></br>
                    </div>
                </div>
                <Seller addToCart={this.props.addToCart}
                        sells={this.props.sell_records.filter((record) => record.record_id === this.props.record.id)}/>
