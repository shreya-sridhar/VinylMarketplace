        ...
        <th scope="row" className="border-0">
          <div className="p-2">
            ...
            <div className="ml-3 d-inline-block align-middle">
              <h5 className="mb-0"> <a href="#" className="text-dark d-inline-block align-middle">{this.props.record.name}</a></h5><span className="text-muted font-weight-normal font-italic d-block">Genre: Indie</span>
            </div>
          </div>
        </th>
        <td className="border-0 align-middle"><strong>{this.props.record.price}</strong></td>
